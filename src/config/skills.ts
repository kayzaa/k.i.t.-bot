...
export const TRADING_SKILLS: SkillInfo[] = [
  ...
  // NEW: Advanced Trading Skills (added 12.02.2026)
  {
    id: 'grid-bot',
    name: 'Grid Trading Bot',
    description: 'Automated grid trading with range detection',
    category: 'trading',
    status: 'ready',
    icon: '📊',
  },
  ...
  },
  {
    id: 'scalping-bot',
    name: 'Scalping Bot',
    description: 'High-frequency micro-profit trades',
    category: 'trading',
    status: 'ready',
    icon: '⚡',
  },
  {
    ...
    description: 'Trade breakouts and momentum shifts',
    category: 'trading',
    status: 'ready',
    icon: '🚀',
  },
  ...
  // NEW: Advanced Analysis Skills
  {
    id: 'volume-profile',
    name: 'Volume Profile',
    description: 'Point of control & value areas',
    category: 'analysis',
    status: 'ready',
    icon: '📶',
  },
  {
    ...
    description: 'Footprint charts & delta analysis',
    category: 'analysis',
    status: 'ready',
    icon: '🌊',
  },
  {
    ...
    description: 'ICT/SMC analysis automation',
    category: 'analysis',
    status: 'ready',
    icon: '🎯',
  },
  {
    ...
    description: 'Gartley, Bat, Butterfly detection',
    category: 'analysis',
    status: 'ready',
    icon: '🦋',
  },
  {
    id: 'elliott-wave',
    name: 'Elliott Wave',
    description: 'Wave count analysis',
    category: 'analysis',
    status: 'beta',
    icon: '🌊',
  },
  
  // NEW: DeFi & Yield Skills
  {
    id: 'airdrop-tracker',
    name: 'Airdrop Tracker',
    description: 'Track upcoming airdrops & eligibility',
    category: 'defi',
    status: 'ready',
    icon: '🎁',
  },
  {
    id: 'nft-tracker',
    name: 'NFT Tracker',
    description: 'NFT floor prices & rarity tracking',
    category: 'defi',
    status: 'ready',
    icon: '🖼️',
  },
  {
    ...
    description: 'Multi-chain staking optimization',
    category: 'defi',
    status: 'ready',
    icon: '🔒',
  },
  {
    ...
    description: 'Cross-chain bridge route finder',
    category: 'defi',
    status: 'ready',
    icon: '🌉',
  },
  
  // NEW: Risk & Protection Skills
  {
    id: 'trailing-stop',
    name: 'Trailing Stop Manager',
    description: 'Dynamic trailing stop-loss management',
    category: 'risk',
    status: 'ready',
    icon: '🛑',
  },
  {
    id: 'drawdown-guard',
    name: 'Drawdown Guard',
    description: 'Auto-pause on max drawdown reached',
    category: 'risk',
    status: 'ready',
    icon: '🛡️',
  },
  {
    id: 'correlation-monitor',
    name: 'Correlation Monitor',
    description: 'Track portfolio correlation risk',
    category: 'risk',
    status: 'ready',
    icon: '🔗',
  },
